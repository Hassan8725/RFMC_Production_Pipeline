...
''' Section 2.2 Checking for Incorrect values and changing Datatype '''
...
''' Section 3.1 Recency, Frequency and MonetaryValue Part '''
...
''' Section 3.2 Making another dataframe with only optimization_metric>0 to correctly discretize Monetary Value'''
...
''' Section 3.3 Discretization of Recency, Frequency and MonetaryValue '''
...
''' Section 3.4 Clumpiness and its discretized column creation '''
...
''' Section 3.5 RFM_data and Clumpliness dataframes merging and Loyalty levels calculation '''
